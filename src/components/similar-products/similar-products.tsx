          ...
          <div className="product-card is-active">
            <div className="product-card__img">
              <picture>
                <source
                  type="image/webp"
                  srcSet="/markup/img/content/fast-shot.webp, /markup/img/content/fast-shot@2x.webp 2x"
                />
                <img
                  src="/markup/img/content/fast-shot.jpg"
                  srcSet="/markup/img/content/fast-shot@2x.jpg 2x"
                  width={280}
                  height={240}
          ...
          <div className="product-card is-active">
            <div className="product-card__img">
              <picture>
                <source
                  type="image/webp"
                  srcSet="/markup/img/content/das-auge.webp, /markup/img/content/das-auge@2x.webp 2x"
                />
                <img
                  src="/markup/img/content/das-auge.jpg"
                  srcSet="/markup/img/content/das-auge@2x.jpg 2x"
                  width={280}
                  height={240}
